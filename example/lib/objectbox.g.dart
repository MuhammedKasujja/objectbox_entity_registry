...
final _entities = <obx_int.ModelEntity>[
  obx_int.ModelEntity(
    id: const obx_int.IdUid(1, 3600929028005701262),
    name: 'Product',
    lastPropertyId: const obx_int.IdUid(3, 3152717962954267357),
    flags: 0,
    properties: <obx_int.ModelProperty>[
      obx_int.ModelProperty(
        id: const obx_int.IdUid(1, 6140047785531088535),
        name: 'id',
        type: 6,
        flags: 1,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(2, 1364927861228556958),
        name: 'title',
        type: 9,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(3, 3152717962954267357),
        name: 'price',
        type: 8,
        flags: 0,
      ),
  ...
  obx_int.ModelEntity(
    id: const obx_int.IdUid(2, 3744766122214962233),
    name: 'User',
    lastPropertyId: const obx_int.IdUid(2, 1485351357526556759),
    flags: 0,
    properties: <obx_int.ModelProperty>[
      obx_int.ModelProperty(
        id: const obx_int.IdUid(1, 9040995650151234915),
        name: 'id',
        type: 6,
        flags: 1,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(2, 1485351357526556759),
        name: 'name',
        type: 9,
        flags: 0,
      ),
